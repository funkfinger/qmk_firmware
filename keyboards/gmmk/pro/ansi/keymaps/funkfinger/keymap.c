...
*********** my keycaps and customizations...
- RGB stuff copied from `stickandgum` keymaps i`gmmk/pro/ansi/keymaps/stickandgum`
...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        LED_TILDE, LED_1,   LED_2,   LED_3,   LED_4,    LED_5,   LED_6,   LED_7,  LED_8,   LED_9,   LED_0,LED_MINS, LED_EQL,  KC_INS,          RGB_TOG,
        _______, _______, RGB_VAI, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RESET,            _______,
        _______, RGB_SAD, RGB_VAD, RGB_SAI, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          RGB_MODE_FORWARD,
        _______,          _______, RGB_HUI, _______, _______, _______, NK_TOGG, _______, _______, _______, _______,          _______, RGB_MOD, RGB_MODE_REVERSE,
